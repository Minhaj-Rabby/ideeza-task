        ...
        <div className="px-4 pt-8">
          ...
          <form className="mt-5 grid gap-6">
            ...
            <div className="relative bg-white">
              <input className="peer hidden text-black bg-black " id="radio_2" type="radio" name="radio"  />
              <span className="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8  "></span>
              <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" >
                <div className="ml-5">
                  <span className="mt-2 font-semibold text-black">Fedex Delivery</span>
                  <p className="text-sm leading-6 text-black">Delivery: 2-4 Days</p>
                </div>
              </label>
            </div>
          </form>
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0 text-black">
          ...
          <div className="">
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <select name="billing-state" className="w-full rounded-md border text-gray-100 border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500">
                <option className='text-gray-200' value="State">State</option>
              </select>
            ...
            <div className="mt-6 border-t border-b py-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="font-semibold text-gray-900">${totalShipping}</p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-gray-900">Tax</p>
                <p className="font-semibold text-gray-900">${tax.toFixed(1)}</p>
              </div>
            </div>
